...
Description of the data used in this project can be found at The UCI Machine Learning Repository
...
Setting the source directory for the files, read into tables the data located in
•features.txt
•activity_labels.txt
•subject_train.txt
•x_train.txt
